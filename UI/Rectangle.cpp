...
SDLEngine::UI::Rectangle::Rectangle(SDL_Rect rect, SDL_Color color, int rounder_radius):
  color_(color),
  rounder_radius_(rounder_radius),
  rect_(rect),
  surface_(),
  texture_()
{
...
void SDLEngine::UI::Rectangle::reRender()
{
  ...
  draw_FillRoundedRectangle(new_surface, 0, 0, rect_.w, rect_.h, rounder_radius_, color);
